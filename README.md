...
<h3 align="center">Gasthaus</h3>
  ...
  Dungeoneer is a project meant to keep track of what collectibles you are missing from dungeons, trials or raids in the game Final Fantasy XIV. You can either store your collection locally or log in and store it on your account. If you decide to log in after using the local collection, you will be given the option to sync your collections.
    <br />
    <a href="https://github.com/gomisroca/gasthaus"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://gasthaus.vercel.app/">View Demo</a>
    ·
    <a href="https://github.com/gomisroca/gasthaus/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/gomisroca/gasthaus/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
![Gasthaus Screen Shot](public/screenshot.png)
...
4. Clone the repo
   ```sh
   git clone https://github.com/gomisroca/gasthaus.git
   ```
...
6. Check `.env.example` and create an `.env` file
   ```js
   DATABASE_URL="postgresql://postgres:password@localhost:5432/gasthaus"
   DIRECT_URL="postgresql://postgres:password@localhost:5432/gasthaus"
   etc...
   ```
...
See the [open issues](https://github.com/gomisroca/gasthaus/issues) for a full list of proposed features (and known issues).
